...
While {_Unit getvariable ["VCOM_LOITERING",true] && alive _Unit} do
{
	...
	_RandomAction = selectRandom ([1,2,3,4] - [_CurrentAction]);
	switch (_RandomAction) do 
	{
			case 1: 
			{
				...
				_RandomAnimationList = selectRandom ["AmovPercMstpSnonWnonDnon_exercisePushup","SitDown","AmovPercMstpSnonWnonDnon_SaluteIn","AmovPercMstpSrasWrflDnon_AinvPknlMstpSlayWrflDnon"];
