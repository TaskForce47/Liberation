...
_red_forces = [ (markerpos _sector), _actual_capture_size,TF47_helper_opposingFaction] call F_getUnitsCount;
_blue_forces = [ (markerpos _sector), _actual_capture_size, TF47_helper_playerFaction ] call F_getUnitsCount;
_ratio = -1;
