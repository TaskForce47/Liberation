...
// If you know what youre doing then sure, proceed :)
...
heavy_vehicles = [
    ["B_APC_Wheeled_01_cannon_F",0,40,15],
    ["B_APC_Tracked_01_rcws_F",0,50,15],
    ["B_APC_Tracked_01_AA_F",0,50,15],
...
buildings = [
    ...
    ["Land_Medevac_HQ_V1_F"             ,0,5,0],
    ["Land_Medevac_house_V1_F"          ,0,5,0]
];
...
if ( isNil "blufor_squad_recon" ) then { 
blufor_squad_recon = [] };
if ( count blufor_squad_recon == 0 ) then { 
...
if ( isNil "blufor_squad_para" ) then { 
blufor_squad_para = [] };
if ( count blufor_squad_para == 0 ) then { 
...
uavs = [] + uavs + [ "B_UAV_01_F","B_UAV_02_F","B_UAV_02_CAS_F","B_UGV_01_F","B_UGV_01_rcws_F", "B_T_UAV_03_F" ];
...
military_alphabet = ["Black Horse","Red Knight","Anna","Boris","Vasilij","Galina","Dmitrij","Jelena","Jolka","Zenja","Zinaida","Ivan","Jot","Konstantin","Leonid","Mixail","Nikolaj","Olga","Roman","Pavel","Sergej","Tamara","Uljana","Fjodor","Xariton","Centr","Celovek","Sura","Scuka","znak","Igrek","Znak","Exo","Jirij","Jakov"];
