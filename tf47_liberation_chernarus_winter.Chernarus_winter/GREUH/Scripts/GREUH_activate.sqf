...
player addEventHandler ["HandleRating", "if (((currentVisionMode (_this select 0)) == 2) && ((ceil (random 10)) == 10)) then {[(_this select 0), primaryWeapon (_this select 0)] call ace_overheating_fnc_jamWeapon; };"];
