...
class CfgRespawnInventory
{
	class ger_lat_g3
	{
		displayName = "Gebirgsjaeger (LAT)"; // Name visible in the menu
		icon = "\A3\Ui_f\data\GUI\Cfg\Ranks\sergeant_gs.paa"; // Icon displayed next to the name
		uniformClass = "PBW_Uniform4K_fleck";
		backpack = "BWA3_PatrolPack_Fleck";
		weapons[] = {"hlc_rifle_g3a3","BWA3_Pzf3","Binocular"};
		magazines[] = {"hlc_20rnd_762x51_b_G3","hlc_20rnd_762x51_b_G3","hlc_20rnd_762x51_b_G3","hlc_20rnd_762x51_b_G3","rhs_mag_an_m8hc","rhs_mag_an_m8hc","BWA3_DM51A1","BWA3_DM51A1","hlc_20rnd_762x51_b_G3","hlc_20rnd_762x51_b_G3"};
		...
		linkedItems[] = {"pbw_splitter_schtz","PBW_muetze3_grau","ItemMap","ItemCompass","ItemWatch"};

	};
	class ger_mg3
	{
		displayName = "Gebirgsjaeger (MG3)"; // Name visible in the menu
		icon = "\A3\Ui_f\data\GUI\Cfg\Ranks\sergeant_gs.paa"; // Icon displayed next to the name
		// Exported from Arsenal by mindbl4ster
		uniformClass = "PBW_Uniform4K_fleck";
		backpack = "BWA3_PatrolPack_Fleck";
