...
military_alphabet = ["Anna","Boris","Vasilij","Galina","Dmitrij","Jelena","Jolka","Zenja","Zinaida","Ivan","Jot","Konstantin","Leonid","Mixail","Nikolaj","Olga","Roman","Pavel","Sergej","Tamara","Uljana","Fjodor","Xariton","Centr","Celovek","Sura","Scuka","znak","Igrek","Znak","Exo","Jirij","Jakov"];
