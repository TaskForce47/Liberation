...
if (hasInterface) exitWith {}; // isn't server
...
_ttdBodies = 15*60; // seconds to delete dead bodies (0 means don't delete)
_ttdVehiclesDead = 20*60; // seconds to delete dead vehicles (0 means don't delete)
_ttdVehiclesImmobile = 60*60; // seconds to delete immobile vehicles (0 means don't delete)
